<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuyCost.aspx.cs" Inherits="WebFit.Report.BuyCost1" %>
    ...
    <form id="form1" runat="server">
        <div class="auto-style3">
             ...
             <asp:CheckBoxList ID="CheckBoxList1" runat="server" CssClass="auto-style4">
                 <asp:ListItem Value="01">อีเมลล์</asp:ListItem>
                 <asp:ListItem Value="02">คอร์ส</asp:ListItem>
                 <asp:ListItem Value="03">วันที่</asp:ListItem>
             </asp:CheckBoxList>
        </div>
         <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="764px" Width="1400px" CssClass="auto-style1"></rsweb:ReportViewer>
    </form>
</body>
</html>
