<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReUser.aspx.cs" Inherits="WebFit.Report.ReUser1" %>
    ...
    <form id="form1" runat="server">
       <div class="auto-style3">
             ...
             <asp:CheckBoxList ID="CheckBoxList1" runat="server" CssClass="auto-style4">
                 ...
                 <asp:ListItem Value="02">อีเมลล์</asp:ListItem>
             </asp:CheckBoxList>
        </div>
         <rsweb:ReportViewer ID="ReportViewer3" runat="server" Height="764px" Width="1400px" CssClass="auto-style1"></rsweb:ReportViewer>
    </form>
</body>
</html>
